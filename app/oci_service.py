            ...
            try:
                ...
                if e.status == 500 and "Out of host capacity" in (e.message or ""):
                    ...
                    _fail(sess, "Превышен лимит бесплатного аккаунта. Если раньше создавали серверы — "
                          ...
                          "запустите охоту заново. Учтите: с июня 2026 Always Free даёт "
                          "бесплатному аккаунту суммарно 2 OCPU и 12 ГБ RAM на все "
                          "ARM-серверы (платным PAYG-аккаунтам — 4/24). Возможно, вы "
                          "просите больше лимита — уменьшите размер сервера.")
                    return
